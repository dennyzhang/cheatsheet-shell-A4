...
* DONE [#A] ls only list folder: ls -ld */                         :noexport:
  CLOSED: [2020-06-11 Thu 22:23]

* TODO [#A] linux: how to view huge logfiles by line offset :noexport:IMPORTANT:
* TODO [#A] How to make sure your Linux system users won't hide or delete their .bash_history / Securing .bash_history file :noexport:
