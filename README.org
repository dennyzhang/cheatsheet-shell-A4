...
| Keep tailing log files                              | =tail -f /var/log/system.log=           |
...
| Check process start command in /proc filesystem     | =cat /proc/$pid/cmdline=                |
*** Echo string
| Name                 | Comment                                                 |
|----------------------+---------------------------------------------------------|
...
* improve command                                                  :noexport:
| Long option for command line    |                                 |
